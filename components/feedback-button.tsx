    ...
    <>
      ...
      {!dismissed && (
        <div className="fixed z-40 flex items-center gap-1 bottom-[130px] right-4 lg:bottom-5 lg:right-5">
          ...
          {/* X to dismiss for this page — mobile only */}
          <button
            onClick={() => setDismissed(true)}
            className="lg:hidden w-5 h-5 rounded-full flex items-center justify-center transition-opacity hover:opacity-80"
