...
const NAV = [
  ...
  { href: "/message-owners",     label: "Outreach",           matchPaths: ["/message-owners", "/track-listing", "/new-owners", "/leads"], tourId: "tour-nav-new-owners",  minPlan: null },
  { href: "/track-renewal",      label: "Track renewal",      matchPaths: ["/track-renewal", "/existing-contracts", "/tenancies"],        tourId: "tour-nav-contracts",   minPlan: null },
