...
const NAV = [
  ...
  { href: "/property-leads",     label: "Outreach",           matchPaths: ["/property-leads", "/potential-listing", "/my-listing", "/lost-listing", "/new-owners", "/leads"], tourId: "tour-nav-new-owners",  minPlan: null },
      ...
      <div className="px-6 py-5 space-y-5">
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <input type="text" value={ren} onChange={(e) => setRen(e.target.value)} placeholder="e.g. REN07128, PEA1234, or REA1234" style={INPUT_STYLE} />
