    ...
    >
      ...
      >
        ...
        <p className="mb-6" style={{ fontSize: "var(--kk-sm)", color: "var(--kk-ink-mute)", lineHeight: 1.65 }}>
          Your data is safe. Resubscribe anytime to restore full access and pick up exactly where you left off.
        </p>
        ...
        >
          Resubscribe <ArrowRight className="w-4 h-4" />
        </a>

        <p className="mt-4" style={{ fontSize: "var(--kk-xs)", color: "var(--kk-ink-faint)" }}>
          Your data is always safe and never deleted.
        </p>
      </div>
    </div>
  );
