...
export function OnboardingNudge({ isNewAgent, hasLeads, hasContracts, hasTenants, hasSupports }: Props) {
  ...
  const missions: Mission[] = [
    { id: "leads",     label: "Upload your owner list",        cta: "Upload now",    href: "/potential-listing",         done: hasLeads },
    { id: "contracts", label: "Add a tenancy contract",        cta: "Add contract",  href: "/existing-listing", done: hasContracts },
