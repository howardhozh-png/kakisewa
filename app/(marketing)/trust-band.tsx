...
/* Real brand logos served from /public/logos/ — actual files, no recreations */

const LOGOS: { key: string; src: string; label: string; height: number }[] = [
  { key: "shell",      src: "/logos/shell.svg",     label: "Shell",             height: 48 },
  { key: "mcdonalds",  src: "/logos/mcdonalds.svg", label: "McDonald's",        height: 44 },
  { key: "pwc",        src: "/logos/pwc.svg",        label: "PwC",               height: 32 },
  { key: "jnj",        src: "/logos/jnj.svg",        label: "Johnson & Johnson", height: 28 },
  { key: "razer",      src: "/logos/razer.svg",      label: "Razer",             height: 28 },
];
